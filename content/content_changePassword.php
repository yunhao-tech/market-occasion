...
if (isset($_POST["login"]) && $_POST["login"] != "" &&
    ...
    if ($b1 && $b2 && $b3) {
        ...
        echo "<script>alert('You have changed your password! Please remerber it carefully.')</script>";
    }
}
...
if (!$entered_values_valid) {
    ...
    <form action="index.php?page=changePassword&todo=changePassword" method="post"
      oninput="up2.setCustomValidity(up2.value != up.value ? 'Two passwprds are different.' : '')">
    <p>
